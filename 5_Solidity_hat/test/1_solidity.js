...
const Lock2 = require("../ignition/modules/Lock2");
...
// – Tells the compiler how to process a file's source code
...
// – Code can be compiled by any minor pathed or updated updates within the same mejor version
...
async function readVar() {
    ...
    const textValue = await lock2.text();
